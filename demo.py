...
if st.session_state.queue_counter <= 10:
    ...
    button_code = f'<a href="#" onclick="event.preventDefault(); {st._get_report_ctx().enqueue(st.experimental_rerun)}" style="padding: 10px 20px; background-color: #FF2E63; color: white; border-radius: 4px; text-decoration: none;">Register</a>'
